...
class PlotGroup:
    ...
    def __init__(self):
        ...
        self.fig1_peth = PlotTemplate('Time From Stimulus Onset (s)', 'Firing Rate (Hz)')
        ...
        self.fig1b_peth = PlotTemplate('Time From Stimulus Onset (s)', 'Fano Factor ')
        self.fig1b_button = QtWidgets.QPushButton('Add')
        self.fig1b_button.setParent(self.fig1b_peth.fig)
        self.fig1b_button.setFixedSize(30, 30)
        self.fig1b_area.addWidget(self.fig1b_peth.fig)
        self.fig2_peth = PlotTemplate('Time From Feedback (s)', 'Firing Rate (Hz)')
        ...
        self.fig2b_peth = PlotTemplate('Time From Feedback (s)', 'Fano Factor ')
        self.fig2b_button = QtWidgets.QPushButton('Add')
        self.fig2b_button.setParent(self.fig2b_peth.fig)
        self.fig2b_button.setFixedSize(30, 30)
        self.fig2b_area.addWidget(self.fig2b_peth.fig)
