...
def callback(parent):
    if parent.subj_win is not None:
        parent.subj_win.close()

    parent.subj_win = ScalingWindow(parent.shank.probe_id, parent.shank.subj, parent.shank.one,
                                    parent.shank.brain_atlas)
