...
from atlaselectrophysiology.ephys_alignment import (EphysAlignment, TIP_SIZE_UM,
                                                    _cumulative_distance)
ba = atlas.AllenAtlas(25)


data = np.load('C:/Users/Mayo/iblenv/iblmayo/fixtures/alignment_data.npz', allow_pickle=True)
