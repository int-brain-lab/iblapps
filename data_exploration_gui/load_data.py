...
parser.add_argument('-d', '--date', default=False, required=True, help='Date of session YYYY-MM-DD')
parser.add_argument('-n', '--session_no', default=False, required=True, help='Session Number')
parser.add_argument('-e', '--ephys_data', default=False, required=False, help='Set True to load ephys.bin data')
