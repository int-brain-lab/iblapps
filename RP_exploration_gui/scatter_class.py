# -*- coding: utf-8 -*-
"""
Created on Fri Nov 20 09:33:40 2020
...
class ScatterGroup:
    ...
    def on_mouse_hover(self, pos):
        ...
        if len(point) != 0:
            ...
            self.scatter_text.setText('Cluster no. ' + str(self.clust_ids[clust]) + ' ' + str(self.clust_areas[clust]))
    ...
    def initialise_scatter_index(self):
        ...
        point[0].setPen('b')
        return (
         self.point_pos, self.point_pos_prev)